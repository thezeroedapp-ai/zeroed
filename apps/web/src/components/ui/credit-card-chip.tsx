...
export default function CreditCardChip({
  ...
  // Prefer institutionName for matching; fall back to cardName (e.g. "Amex Gold Card" → amex)
  ...
  return (
    <div
      ...
      style={{
        ...
        // Two-stop gradient: brand color top-left → slightly darker bottom-right
        background: `linear-gradient(135deg, ${brandColor}EE 0%, ${brandColor} 100%)`,
      }}
    >
      {/* Top-left gloss — simulates card sheen */}
      <div
      ...
      {/* EMV chip — purely decorative, bottom-left */}
      <div
        className="absolute"
        style={{
      ...
      {/* Institution logo — bottom-right, like real card placement */}
      {url && !logoFailed ? (
        <img
          src={url}
          alt={lookupName}
        ...
        // Text fallback: first two chars of institution name, white
        <span
